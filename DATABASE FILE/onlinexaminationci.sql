...
INSERT INTO `h_test` (`id`, `test_id`, `mahasiswa_id`, `list_soal`, `list_jawaban`, `jml_benar`, `nilai`, `nilai_bobot`, `tgl_mulai`, `tgl_selesai`, `status`) VALUES
...
INSERT INTO `m_test` (`id_test`, `dosen_id`, `matkul_id`, `nama_test`, `jumlah_soal`, `waktu`, `jenis`, `tgl_mulai`, `terlambat`, `token`) VALUES
...
--
-- AUTO_INCREMENT for table `h_test`
--
ALTER TABLE `h_test`
...
--
-- Constraints for table `h_test`
--
ALTER TABLE `h_test`
  ADD CONSTRAINT `h_test_ibfk_1` FOREIGN KEY (`test_id`) REFERENCES `m_test` (`id_test`),
  ADD CONSTRAINT `h_test_ibfk_2` FOREIGN KEY (`mahasiswa_id`) REFERENCES `mahasiswa` (`id_mahasiswa`);
...
--
ALTER TABLE `m_test`
  ADD CONSTRAINT `m_test_ibfk_1` FOREIGN KEY (`dosen_id`) REFERENCES `dosen` (`id_dosen`),
  ADD CONSTRAINT `m_test_ibfk_2` FOREIGN KEY (`matkul_id`) REFERENCES `matkul` (`id_matkul`);
