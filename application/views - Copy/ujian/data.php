<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="pull-right">
            <a href="<?=base_url('test/add')?>" class="btn bg-blue btn-sm btn-flat"><i class="fa fa-plus"></i> Conduct New Exam</a>
            <button type="button" onclick="reload_ajax()" class="btn btn-sm btn-flat bg-maroon"><i class="fa fa-refresh"></i> Reload</button>
        </div>
    </div>
	<?=form_open('test/delete', array('id'=>'bulk'))?>
    <div class="table-responsive px-4 pb-3" style="border: 0">
        <table id="test" class="w-100 table table-striped table-bordered table-hover">
        <thead>
            <tr>
...
<script src="<?=base_url()?>assets/dist/js/app/test/data.js"></script>