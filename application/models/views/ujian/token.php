...
<div class="box box-primary">
    ...
    <div class="box-body">
        <span id="id_test" data-key="<?=$encrypted_id?>"></span>
        <div class="row">
            <div class="col-sm-6">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Late</th>
                        <td>
                            <?=strftime('%d %B %Y', strtotime($test->terlambat))?> 
                            <?=date('H:i:s', strtotime($test->terlambat))?>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="col-sm-6">
                <div class="box box-solid">
                    <div class="box-body pb-0">
                        ...
                        <?php
                        $mulai = strtotime($test->tgl_mulai);
                        $terlambat = strtotime($test->terlambat);
                        $now = time();
                        if($mulai > $now) : 
                        ?>
                        <div class="callout callout-success">
                            ...
                            <br>
                            <span class="countdown" data-time="<?=date('Y-m-d H:i:s', strtotime($test->tgl_mulai))?>">00 Days, 00 Hours, 00 Minutes, 00 Seconds</strong><br/>
                        </div>
                        <?php elseif( $terlambat > $now ) : ?>
                        <button id="btncek" data-id="<?=$test->id_test?>" class="btn btn-success btn-lg mb-4">
                            <i class="fa fa-pencil"></i> Start
                        </button>
                        <div class="callout callout-danger">
                            <i class="fa fa-clock-o"></i> <strong class="countdown" data-time="<?=date('Y-m-d H:i:s', strtotime($test->terlambat))?>">00 Days, 00 Hours, 00 Minutes, 00 Seconds</strong><br/>
