<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                <?=form_open('test/save', array('id'=>'formtest'), array('method'=>'add','dosen_id'=>$dosen->id_dosen, 'matkul_id'=>$matkul->matkul_id))?>
                <div class="form-group">
                    <label for="nama_test">Exam Name</label>
                    <input autofocus="autofocus" onfocus="this.select()" placeholder="Exam Name" type="text" class="form-control" name="nama_test">
